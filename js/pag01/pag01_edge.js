                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['46px', '393px', '370px', '23px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['452px', '135px', '513px', '305px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'image',
                            rect: ['-17px', '243px', '526px', '341px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['-285px', '367px', '269px', '32px', 'auto', 'auto'],
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['183px', '536px', '353px', '32px', 'auto', 'auto'],
