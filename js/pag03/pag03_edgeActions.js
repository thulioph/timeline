...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7380, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 10955, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "${imagem03_02_02}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openImage ("page03_02_02");
   ...
   //Edge symbol: 'texto_03_03_01'
   (function(symbolName) {   
   
   })("texto_03_03_01");
   //Edge symbol end:'texto_03_03_01'
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-13578893");